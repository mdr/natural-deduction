...
/**
 * https://github.com/massung/scala-js-mousetrap/blob/master/src/main/scala/blog/codeninja/scalajs/mousetrap/Mousetrap.scala
 */
//noinspection ScalaUnusedSymbol

@js.native
@JSImport("mousetrap", JSImport.Default)
